...
for (cohort in cohorts) {
  print(cohort)
  raw_table <- read_biom(file.path(paste0('~/Desktop/thesis/vaginalMicrobiome/01-Reproducibility_Replicability/Antonio_Walsh_pipeline/results/', cohort, '_cohort/test_paired.biom')))
  ...
  # read in tax data 
  tax_table <- read.delim(file.path(paste0('~/Desktop/thesis/vaginalMicrobiome/01-Reproducibility_Replicability/Antonio_Walsh_pipeline/results/', cohort, '_cohort/test_paired.probs.taxonomy')), header = FALSE, sep = "\t")
