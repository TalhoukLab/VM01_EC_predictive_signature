...
chao_pipeline_plots <- (Chao_Chao_beta+ggtitle("Chao") + theme(legend.position = "none")  + scale_color_manual(values=c("khaki", "yellowgreen", "tomato3"))| 
                           Antonio_Chao_beta+ggtitle("Antonio")  + theme(legend.position = "none") + scale_color_manual(values=c("khaki", "yellowgreen", "tomato3"))|
                           Gressel_Chao_beta+ggtitle("Gressel") + theme(legend.position = "none")  + scale_color_manual(values=c("yellowgreen","tomato3")) |
                           Tsementzi_Chao_beta + ggtitle("Tsementzi") + theme(legend.position = "none")+ scale_color_manual(values=c("yellowgreen","tomato3")) |
                           Walsh_Chao_beta+ggtitle("Walsh") +  theme(legend.position = "none") +scale_color_manual(values=c("khaki", "yellowgreen", "tomato3")))

antonio_pipeline_plots <- (Chao_Antonio_beta + theme(legend.position = "none")  + scale_color_manual(values=c("yellowgreen", "khaki", "tomato3"))| 
...
tsementzi_pipeline_plots <- (Chao_Tsementzi_beta + theme(legend.position = "none")  + scale_color_manual(values=c("yellowgreen", "khaki", "tomato3"))| 
...
walsh_pipeline_plots <- (Chao_Walsh_beta  + theme(legend.position = "none") + scale_color_manual(values=c("yellowgreen", "khaki", "tomato3"))| 
...
inhouse_pipeline_plots <- (Chao_InHouse_beta  + theme(legend.position = "none") + scale_color_manual(values=c("khaki", "yellowgreen", "tomato3"))| 
...
p <- (chao_pipeline_plots / antonio_pipeline_plots / tsementzi_pipeline_plots / walsh_pipeline_plots / inhouse_pipeline_plots)
