...
saveRDS(rand_forest_res_grid, "~/Desktop/thesis/VM02_meta_analysis/src/updated/updated1/Walsh_all_clinical_rf_grid.rds")
saveRDS(final_fit_rf, "~/Desktop/thesis/VM02_meta_analysis/src/updated/updated1/Walsh_all_clinical_rf_fit.rds")
...
nnet_results_chao_grid <- get_metrics_indi(data = test_data_complete_sub, model = final_fit_nnet, 
                                           level = "genus", labels = sample_data(Antonio1_solo_res$raw)$histology)
saveRDS(nnet_res, "~/Desktop/thesis/VM02_meta_analysis/src/updated/updated1/Walsh_all_clinical_nnet_grid.rds")
saveRDS(final_fit_nnet, "~/Desktop/thesis/VM02_meta_analysis/src/updated/updated1/Walsh_all_clinical_nnet_fit.rds")
...
xgb_results_chao_grid <- get_metrics_indi(data = test_data_complete_sub, model = final_fit_bt, 
                                          level = "genus", labels = sample_data(Antonio1_solo_res$raw)$histology)
saveRDS(xgb_res, "~/Desktop/thesis/VM02_meta_analysis/src/updated/updated1/Walsh_all_clinical_xgb_grid.rds")
saveRDS(final_fit_bt, "~/Desktop/thesis/VM02_meta_analysis/src/updated/updated1/Walsh_all_clinical_xgb_fit.rds")
