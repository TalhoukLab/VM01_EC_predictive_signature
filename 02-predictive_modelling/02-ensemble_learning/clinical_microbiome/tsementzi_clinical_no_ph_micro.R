...
rand_forest_res_grid <- tune_grid(object = rand_forest_wflow, 
                                  resamples = folds,  grid = 5,
                                  metrics = metric,
                                  control = ctrl_res) 

final_rf_wf <- rand_forest_wflow %>% 
  finalize_workflow(list(mtry = 47, trees = 2500, min_n = 2))
...
saveRDS(rand_forest_res_grid, "~/Desktop/thesis/VM02_meta_analysis/src/updated/Tsementzi3_clinical_no_ph_micro_rf_grid.rds")
saveRDS(final_fit_rf, "~/Desktop/thesis/VM02_meta_analysis/src/updated/Tsementzi3_clinical_no_ph_micro_rf_fit.rds")
...
nnet_grid <- expand.grid(hidden_units = seq(5, 300, 5), penalty = seq(0, 1, 0.1), epochs = seq(5, 11, 2))
nnet_res <-tune_grid(object = nnet_wflow, metrics = metric, resamples = folds, 
                     grid = 100, control = ctrl_res)
...
saveRDS(nnet_res, "~/Desktop/thesis/VM02_meta_analysis/src/updated/Tsementzi1_clinical_no_ph_micro_nnet_grid.rds")
saveRDS(final_fit_nnet, "~/Desktop/thesis/VM02_meta_analysis/src/updated/Tsementzi1_clinical_no_ph_micro_nnet_fit.rds")
...
saveRDS(xgb_res, "~/Desktop/thesis/VM02_meta_analysis/src/updated/Tsementzi1_clinical_no_ph_micro_xgb_grid.rds")
saveRDS(final_fit_bt, "~/Desktop/thesis/VM02_meta_analysis/src/updated/Tsementzi1_clinical_no_ph_micro_xgb_fit.rds")
