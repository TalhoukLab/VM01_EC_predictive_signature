...
rf_grid <- expand.grid(mtry = seq(40, 150, 5), min_n = seq(1, 15, 2), trees = seq(1500, 2500, 100))
...
saveRDS(rand_forest_res_grid, "~/Desktop/thesis/VM02_meta_analysis/src/updated/Walsh_microbiome_rf_grid.rds")
saveRDS(final_fit_rf, "~/Desktop/thesis/VM02_meta_analysis/src/updated/Walsh_microbiome_rf_fit.rds")
...
saveRDS(nnet_res, "~/Desktop/thesis/VM02_meta_analysis/src/updated/Tsementzi_microbiome_nnet_grid.rds")
saveRDS(final_fit_nnet, "~/Desktop/thesis/VM02_meta_analysis/src/updated/Tsementzi_microbiome_nnet_fit.rds")


saveRDS(final_fit_nnet, "~/Desktop/Tsementzi_micro.rds")
...
## Grid tuning for xgb
xgb_grid <- expand.grid(mtry = seq(1, 150, 10), trees = 1500, min_n = seq(2, 8, 2), 
                        tree_depth = seq(2, 15, 2), learn_rate = 0.002623724, 
                        loss_reduction = 9.899730e-04, sample_size = seq(0.5, 0.8, 0.1), 
                        stop_iter = 20)
